...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Settings') }}
                            ...
                            <div class="row gutters-sm">
                                ...
                                <div class="card">
                                    ...
                                    <nav class="nav flex-column nav-pills nav-gap-y-1">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-credit-card mr-2"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>Billing Information
                                        </a>
                                    </nav>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="tab-pane active" id="profile">
                                        ...
                                        <hr>
                                        <form action="/update_profile_informations" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="fullName">Full Name </label>
                                            <input type="text" class="form-control" id="fullName" name="name" aria-describedby="fullNameHelp" placeholder="Enter your Full Name" value="{{Auth::user()->name}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control autosize" id="bio" name="bio" placeholder="Write something about you" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 62px;">{{Auth::user()->bio}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="url">URL</label>
                                            <input type="text" class="form-control" id="url" name="url" placeholder="Enter your website address. Example: http://www.ams.com/" value="{{Auth::user()->url}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="location">Location</label>
                                            <input type="text" class="form-control" id="location" name="location" placeholder="Enter your location. Example: Mirpur-2(Duip Abashik), Dhaka-1216, BD" value="{{Auth::user()->location}}">
                                        </div>
                                    ...
                                    <div class="tab-pane" id="account">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="user_email" aria-describedby="user_emailHelp" placeholder="Enter your Email. Example: example@gamil.com" value="{{Auth::user()->email}}" disabled>
                                            <small id="user_emailHelp" class="form-text text-muted">After changing your email, your old email becomes available for anyone else to claim.</small>
                                        </div>
                                        <hr>
                                        <div class="form-group">
                                        ...
                                        <a href="{{ route('deleteMe') }}" type="button" class="btn btn-danger text-white" type="button">Delete Account</a>
                                        </form>
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <li class="list-group-item has-icon">
                                                ...
                                                <h6 class="mb-0">Bangladesh @php 
                                                    ...
                                                    @endphp</h6>
                                                <small class="text-muted">Your current session seen in Bangladesh</small>
                                                </div>
